...
import ClosingCountRows from "../components/closing/ClosingCountRows";
          ...
          <div className="fixed inset-0 bg-black/70 flex items-center justify-center z-50 p-4">
            <div className="bg-white dark:bg-gray-800 rounded-xl p-6 w-full max-w-4xl mx-4">
              ...
              <div className="space-y-4 max-h-[65vh] overflow-y-auto pr-1">
                ...
                {hasPaymentStats && (
                  <ClosingCountRows
                    stats={Object.values(paymentStats)}
                    counted={closingAmounts}
                    onCountChange={handleClosingAmountChange}
